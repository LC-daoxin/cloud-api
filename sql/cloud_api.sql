...
VALUES
    (1, 0, 11000, 0, 'EVO Max 4T', NULL),
    (2, 0, 11000, 1, 'EVO Max 4N', NULL),
    (3, 0, 11001, 0, 'ALPHA', NULL),
    (4, 1, 11002, 0, 'MODEL E', NULL),
    (5, 0, 11003, 0, 'MODEL J', NULL),
    (6, 0, 11020, 0, '龙鱼Lite', NULL),
    (7, 0, 11022, 0, '龙鱼Standard', NULL),
    (8, 0, 11023, 0, '龙鱼Pro', NULL),
    (9, 0, 11024, 0, '龙鱼-25', NULL),
    (10, 1, 10052, 0, 'Fusion 4T', NULL),
    (11, 1, 11020, 0, 'Fusion 4T', NULL),
    (12, 2, 20119, 0, 'UAV Smart Controller V3', 'EVO Max 系列配套遥控器'),

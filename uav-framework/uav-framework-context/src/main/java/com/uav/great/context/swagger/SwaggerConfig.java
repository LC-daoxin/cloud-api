package com.uav.great.context.swagger;
...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info().title("UAVrobotics Cloud API.").description("All HTTP interfaces encapsulated by Cloud Api.")
                        .license(new License().name("LICENSE").url("https://github.com/uav-cloud-api/blob/main/LICENSE"))

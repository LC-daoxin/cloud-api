package com.uav.great.websocket.enums;

import io.swagger.v3.oas.annotations.media.Schema;

@Schema(enumAsRef = true, description = "Nest will receive these bizCode, and then do corresponding processing according to the value.")
